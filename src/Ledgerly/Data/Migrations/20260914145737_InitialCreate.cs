    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "TEXT", nullable: false),
                    ActiveLedgerId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LowBalanceThreshold = table.Column<decimal>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualRatePercent = table.Column<decimal>(type: "TEXT", nullable: false),
                    TermMonths = table.Column<int>(type: "INTEGER", nullable: false),
                    FirstPaymentDate = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    PaymentOverride = table.Column<decimal>(type: "TEXT", nullable: true),
                    ExtraPrincipal = table.Column<decimal>(type: "TEXT", nullable: false),
                    CurrentBalance = table.Column<decimal>(type: "TEXT", nullable: true),
                    BalanceAsOf = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositToAccountId = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    Notes = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Incomes_Accounts_DepositToAccountId",
                        column: x => x.DepositToAccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incomes_Ledgers_LedgerId",
                        column: x => x.LedgerId,
                        principalTable: "Ledgers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartDate = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    EndDate = table.Column<DateOnly>(type: "TEXT", nullable: true),
                    PayFromAccountId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bills_Accounts_PayFromAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BillOccurrences_Bills_BillId",
                        column: x => x.BillId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillOccurrences_BillId_DueDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bills_PayFromAccountId",
                table: "Bills",
                column: "PayFromAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Incomes_DepositToAccountId",
                table: "Incomes",
                column: "DepositToAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Incomes_LedgerId",
                table: "Incomes",
                column: "LedgerId");

            migrationBuilder.CreateIndex(
                name: "IX_Ledgers_OwnerId_IsSample",
                table: "Ledgers",
                columns: new[] { "OwnerId", "IsSample" },
                unique: true);
